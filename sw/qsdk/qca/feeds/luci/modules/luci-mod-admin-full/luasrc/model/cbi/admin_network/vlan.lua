...
m = Map("network", translate("VLAN"), translate("The network ports on this device can be combined to several <abbr title=\"Virtual Local Area Network\">VLAN</abbr>s in which computers can communicate directly with each other. <abbr title=\"Virtual Local Area Network\">VLAN</abbr>s are often used to separate different network segments. Often there is by default one Uplink port for a connection to the next greater network like the internet and other ports for a local network."))
...
m.uci:foreach("network", "switch",
	function(x)
		...
		s = m:section(NamedSection, x['.name'], "switch",
			switch_title and translatef("VLAN %q (%s)", switch_name, switch_title)
					      or translatef("VLAN %q", switch_name))
