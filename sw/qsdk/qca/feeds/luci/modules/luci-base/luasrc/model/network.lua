...
function wifinet.wds(self)
	return _uci_state:get("wireless", self.sid, "wds") or "0"
end
...
function wifinet.active_mode(self)
	...
	local wds = _stror(self.iwdata.wds, self.iwinfo.wds) or "0"
...
function wifinet.adminlink(self)
	return dsp.build_url("admin", "wireless", "wireless", self.netid)
end
