...
/* Size of kwn_link_stats = 1+6+4+32+32+32+32+2+2+1+1+1+1+2+2 = 151 bytes */
typedef struct
{
...
/* Size of kwn_cfg_update = 4+1+33+1+1+1+1+6+2+4+4+33+1 = 82 bytes */
typedef struct
{
    ...
    uint8_t  cust_name[33]; /*   cust_name - 32 bytes */
