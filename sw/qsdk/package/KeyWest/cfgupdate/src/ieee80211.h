...
struct ieee80211req_sta_info {
        ...
        u_int32_t isi_local_snr_a1;        /* Local SNR A1 */
        u_int32_t isi_local_snr_a2;        /* Local SNR A2 */
        u_int32_t isi_remote_snr_a1;        /* Remote SNR A1 */
        u_int32_t isi_remote_snr_a2;        /* Remote SNR A2 */
